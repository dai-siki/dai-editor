...
/***/ function(module, exports, __webpack_require__) {
	...
	window.DaiEditor = _editor2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var E = function E(id, argConf) {
		var E = this;
		// 根元素
		E.baseEle = _dom2.default.getById(id);

		// 配置
		E.conf = (0, _assign2.default)(_conf2.default, argConf);

		// 提示
		E.csl = (0, _csl2.default)(E.conf.debug);
	...
	E.fn.init = function () {
		var that = this,
		    menuBaseEle = _dom2.default.create('div'),
		...
		_dom2.default.addClass(menuBaseEle, 'dai-editor-menu-list');
		_dom2.default.addClass(cntBaseEle, 'dai-editor-cnt');
	  ...
	  */
		var menuEventBind = function menuEventBind(ele, cmd) {
			var opt = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
			var callback = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : emptyFn;
		...
		(0, _keys2.default)(simpleMenuCmdList).forEach(function (id) {
			var els = that.menuEleList[id];
			if (els) {
	...
	E.fn.getCnt = function () {
		var cntBaseEle = this.cntBaseEle;

		return _dom2.default.content(cntBaseEle);
	};
	...
	E.fn.setCnt = function (cnt) {
		...
		return _dom2.default.content(cntBaseEle, cnt);
	};
...
/***/ function(module, exports) {
	...
	exports.default = function (isAllowed) {
		if (isAllowed) {
			return csl;
		} else {
			return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		setAttr: function setAttr(ele, attr) {
			(0, _keys2.default)(attr).forEach(function (name) {
		...
		// 节点类型
		type: function type(ele) {
			return ele.nodeType;
		},

		// 节点文本
		text: function text(ele) {
			var _text = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
		...
		// 元素内容可编辑
		editable: function editable(ele) {
			var yn = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;

			ele.contentEditable = yn;
		},

		// 元素内容可编辑
		isEditable: function isEditable(ele) {
			return ele.isContentEditable;
		},

		// 添加子元素，塞到尾部
		pushChild: function pushChild(par, chi) {
			if (Array.isArray(chi)) {
				chi.forEach(function (ele) {
					par.appendChild(ele);
				});
			} else {
	  ...
	  */
		addClass: function addClass(ele, cn) {
			var oldClassArr = ele.className.split(' '),
			    cnArr = void 0;
			if (Array.isArray(cn)) {
				cnArr = cn;
			} else {
			...
			if (oldClassArr.length > 0 && cnArr.length > 0) {
				oldClassArr.forEach(function (n) {
		...
		removeClass: function removeClass(ele, cn) {
			var oldClassArr = ele.className.split(' '),
			    cnArr = void 0;
			if (Array.isArray(cn)) {
				cnArr = cn;
	  ...
	  */
		setStyle: function setStyle(ele, opts) {
...
/***/ function(module, exports) {
	...
	exports.default = {
		...
		// 字体
		familys: ['宋体', '黑体', '楷体', '微软雅黑', 'Arial', 'Verdana', 'Georgia', 'Times New Roman', 'Microsoft JhengHei', 'Trebuchet MS', 'Courier New', 'Impact', 'Comic Sans MS', 'Consolas'],
